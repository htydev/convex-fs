...
- **Private user content** (personal files, confidential documents): You'll want
  to verify the user has permission to access this specific blob.

For private content, you'll typically need to look up which file(s) reference
this blob and check if the user has access:
